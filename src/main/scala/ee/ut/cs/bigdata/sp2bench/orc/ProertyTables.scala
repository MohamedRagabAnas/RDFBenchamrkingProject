...
object ProertyTables {
  ...
  def main(args: Array[String]): Unit = {
    ...
    val RDFDFJournal = spark.read.format("org.apache.spark.sql.execution.datasources.orc").load("hdfs://quickstart:8020/user/cloudera/RDFBenchHDFS/ORC/PropertyTables/Journal").toDF()
    //RDFDFJournal.write.format("org.apache.spark.sql.execution.datasources.orc").save("./ORC/PropertyTables/Journal")
    RDFDFJournal.createOrReplaceTempView("Journal")
    //spark.sql("create table if not exists Journal as select * from JournalDF")



    val RDFDFinProceedingArticle = spark.read.format("org.apache.spark.sql.execution.datasources.orc").load("hdfs://quickstart:8020/user/cloudera/RDFBenchHDFS/ORC/PropertyTables/InProceedingArticle").toDF()
    //RDFDFinProceedingArticle.write.format("org.apache.spark.sql.execution.datasources.orc").save("./ORC/PropertyTables/InProceedingArticle")
    ...
    val RDFDFPerson = spark.read.format("org.apache.spark.sql.execution.datasources.orc").load("hdfs://quickstart:8020/user/cloudera/RDFBenchHDFS/ORC/PropertyTables/Person").toDF()
    //RDFDFPerson.write.format("org.apache.spark.sql.execution.datasources.orc").save("./ORC/PropertyTables/Person")
    RDFDFPerson.createOrReplaceTempView("Person")
    //spark.sql("create table if not exists Person as select * from PersonDF")

    val RDFDFJournalArticle = spark.read.format("org.apache.spark.sql.execution.datasources.orc").load("hdfs://quickstart:8020/user/cloudera/RDFBenchHDFS/ORC/PropertyTables/JournalArticle").toDF()
    //RDFDFJournalArticle.write.format("org.apache.spark.sql.execution.datasources.orc").save("./ORC/PropertyTables/JournalArticle")
    ...
    val RDFDFDocument = spark.read.format("org.apache.spark.sql.execution.datasources.orc").load("hdfs://quickstart:8020/user/cloudera/RDFBenchHDFS/ORC/PropertyTables/Document").toDF()
