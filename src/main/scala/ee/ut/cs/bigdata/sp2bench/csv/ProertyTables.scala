...
object ProertyTables {
  ...
  def main(args: Array[String]): Unit = {
    ...
    //RDFDFJournal.write.format("org.apache.spark.sql.execution.datasources.orc").save("./CSV/PropertyTables/Journal")
    ...
    //RDFDFinProceedingArticle.write.format("org.apache.spark.sql.execution.datasources.orc").save("./CSV/PropertyTables/InProceedingArticle")
    ...
    //RDFDFPerson.write.format("org.apache.spark.sql.execution.datasources.orc").save("./CSV/PropertyTables/Person")
    ...
    //RDFDFJournalArticle.write.format("org.apache.spark.sql.execution.datasources.orc").save("./CSV/PropertyTables/JournalArticle")
    ...
    val RDFDFDocument = spark.read.format("csv").option("header", "true").option("inferSchema", "true").load("hdfs://quickstart:8020/user/cloudera/RDFBenchHDFS/CSV/PropertyTables/MyDocumentPublicationsVenues.csv").toDF()
