...
object VerticalTables {
  ...
  def main(args: Array[String]): Unit = {
    ...
    val RDFDFTitle = spark.read.format("org.apache.spark.sql.execution.datasources.orc").load("hdfs://quickstart:8020/user/cloudera/RDFBenchHDFS/ORC/VerticalTables/title").toDF()
    //RDFDFTitle.write.format("org.apache.spark.sql.execution.datasources.orc").save("./ORC/VerticalTables/title")
   ...
   // spark.sql("create table if not exists Title as select * from TitleRDF")
    ...
    val RDFDFIssued = spark.read.format("org.apache.spark.sql.execution.datasources.orc").load("hdfs://quickstart:8020/user/cloudera/RDFBenchHDFS/ORC/VerticalTables/issued").toDF()
    //RDFDFIssued.write.format("org.apache.spark.sql.execution.datasources.orc").save("./ORC/VerticalTables/issued")
    ...
    val RDFDFType = spark.read.format("org.apache.spark.sql.execution.datasources.orc").load("hdfs://quickstart:8020/user/cloudera/RDFBenchHDFS/ORC/VerticalTables/type").toDF()
    //RDFDFType.write.format("org.apache.spark.sql.execution.datasources.orc").save("./ORC/VerticalTables/type")
    ...
    val RDFDFCreator = spark.read.format("org.apache.spark.sql.execution.datasources.orc").load("hdfs://quickstart:8020/user/cloudera/RDFBenchHDFS/ORC/VerticalTables/creator").toDF()
    //RDFDFCreator.write.format("org.apache.spark.sql.execution.datasources.orc").save("./ORC/VerticalTables/creator")
    ...
    val RDFDFBookTitle = spark.read.format("org.apache.spark.sql.execution.datasources.orc").load("hdfs://quickstart:8020/user/cloudera/RDFBenchHDFS/ORC/VerticalTables/booktitle").toDF()
    //RDFDFBookTitle.write.format("org.apache.spark.sql.execution.datasources.orc").save("./ORC/VerticalTables/booktitle")
    ...
    val RDFDFPartOf = spark.read.format("org.apache.spark.sql.execution.datasources.orc").load("hdfs://quickstart:8020/user/cloudera/RDFBenchHDFS/ORC/VerticalTables/partOf").toDF()
    //RDFDFPartOf.write.format("org.apache.spark.sql.execution.datasources.orc").save("./ORC/VerticalTables/partOf")
    ...
    val RDFDFSeeAlso = spark.read.format("org.apache.spark.sql.execution.datasources.orc").load("hdfs://quickstart:8020/user/cloudera/RDFBenchHDFS/ORC/VerticalTables/seeAlso").toDF()
    //RDFDFSeeAlso.write.format("org.apache.spark.sql.execution.datasources.orc").save("./ORC/VerticalTables/seeAlso")
    ...
    val RDFDFPages= spark.read.format("org.apache.spark.sql.execution.datasources.orc").load("hdfs://quickstart:8020/user/cloudera/RDFBenchHDFS/ORC/VerticalTables/pages").toDF()
    //RDFDFPages.write.format("org.apache.spark.sql.execution.datasources.orc").save("./ORC/VerticalTables/pages")
    ...
    val RDFDFHomePage= spark.read.format("org.apache.spark.sql.execution.datasources.orc").load("hdfs://quickstart:8020/user/cloudera/RDFBenchHDFS/ORC/VerticalTables/homepage").toDF()
    //RDFDFHomePage.write.format("org.apache.spark.sql.execution.datasources.orc").save("./ORC/VerticalTables/homepage")
    ...
    val RDFDFAbstract= spark.read.format("org.apache.spark.sql.execution.datasources.orc").load("hdfs://quickstart:8020/user/cloudera/RDFBenchHDFS/ORC/VerticalTables/abstract").toDF()
    //RDFDFAbstract.write.format("org.apache.spark.sql.execution.datasources.orc").save("./ORC/VerticalTables/abstract")
    ...
    val RDFDFName= spark.read.format("org.apache.spark.sql.execution.datasources.orc").load("hdfs://quickstart:8020/user/cloudera/RDFBenchHDFS/ORC/VerticalTables/name").toDF()
    //RDFDFName.write.format("org.apache.spark.sql.execution.datasources.orc").save("./ORC/VerticalTables/name")
    ...
    val RDFDFJournal= spark.read.format("org.apache.spark.sql.execution.datasources.orc").load("hdfs://quickstart:8020/user/cloudera/RDFBenchHDFS/ORC/VerticalTables/journal").toDF()
    //RDFDFJournal.write.format("org.apache.spark.sql.execution.datasources.orc").save("./ORC/VerticalTables/journal")
    RDFDFJournal.createOrReplaceTempView("inJournal")
    //spark.sql("create table if not exists inJournal as select * from inJournalDF")


    val RDFDFsubClassOf= spark.read.format("org.apache.spark.sql.execution.datasources.orc").load("hdfs://quickstart:8020/user/cloudera/RDFBenchHDFS/ORC/VerticalTables/subClassOf").toDF()
    RDFDFsubClassOf.createOrReplaceTempView("subClassOf")


    val RDFDFEditor= spark.read.format("org.apache.spark.sql.execution.datasources.orc").load("hdfs://quickstart:8020/user/cloudera/RDFBenchHDFS/ORC/VerticalTables/editor").toDF()
    RDFDFEditor.createOrReplaceTempView("Editor")


    val RDFDF = spark.read.format("org.apache.spark.sql.execution.datasources.orc").load("hdfs://quickstart:8020/user/cloudera/RDFBenchHDFS/ORC/SingleTable").toDF()
